...
#Creacion del GUI - Grafical User Interface
gui = Tk() 
#Titulo del GUI
gui.title("Mi calculadora")
...
#Creacion de una caja de texto para el primer número
numero1=StringVar()
...
var2 = StringVar()
var2.set("Escribe el segundo número:")
label2 = Label(gui,textvariable=var2,height = 2)
label2.pack()

#Creacion de otra caja de texto para el segundo número
numero2=StringVar()
